...
CREATE TABLE IF NOT EXISTS `tbl_transaction` (
  ...
  `type` enum('수입','지출') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
-- 테이블 데이터 reactdb.tbl_transaction:~1 rows (대략적) 내보내기
INSERT INTO `tbl_transaction` (`id`, `user_id`, `description`, `amount`, `type`, `category`, `date`) VALUES
	(7, 'hong1', '월급', 3000000, '수입', '급여', '2024-10-25 16:49:21');
